 <menu class="menu-invisible">
     <div class="menu-buttons">
         <button class="menu-button largeW" delay="0.15s">Home</button>
         <button class="menu-button largeW" delay="0.30s">Nieuws</button>
         <button class="menu-button largeW" delay="0.45s">Contact</button>
         <button class="menu-button largeW largeH" delay="0.60s">
             Crafted<br>
             <span class="smallFont">&</span><br>
             Friends
         </button>
         <button class="menu-button largeW" delay="0.75s">Tickets</button>
         <button class="menu-button largeW" delay="0.90s">Programma</button>
     </div>
     <div class="info-container">
         ...
         <div class="socials">
             <div class="social-image-container" delay="0.15s">
             ...
             <div class="social-image-container" delay="0.30s">
             ...
             <div class="social-image-container" delay="0.45s">
             ...
             <div class="social-image-container" delay="0.60s">
                 <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 51 51" class="icon">
