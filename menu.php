     ...
     <div class="info-container">
         ...
         <div class="socials">
             ...
             foreach ($socials as $key => $data):
                 if ($data['url']):
                     ?>
             <a href="<?php echo esc_url($data['url']); ?>" target="_blank" class="social-circle-btn social-image-container" delay="<?php echo esc_attr($data['delay']); ?>" aria-label="<?php echo esc_attr(ucfirst($key)); ?>">
                 <?php echo $data['svg']; ?>
             </a>
